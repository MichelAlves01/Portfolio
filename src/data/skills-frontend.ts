...
export const skillsFrontend: Array<Skill> = [
    ...
    { 
        ...
        "content": `
            ...
            <p>In terms of CSS, I have a deep understanding of modern layout techniques, including Flex box and CSS Grid, which I use to create responsive and visually appealing designs that work seamlessly across different devices and screen sizes. I am proficient in writing clean and maintainable CSS, following best practices such as BEM (Block, Element, Modifier) naming conventions to ensure that styles are easy to manage and scale as projects grow.</p>
